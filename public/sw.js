...
self.addEventListener("fetch", (event) => {
  ...
  const appShellRequest = event.request.mode === "navigate" || ["/", "/index.html", "/app.js", "/platform.js", "/styles.css", "/manifest.webmanifest"].includes(url.pathname);
  if (appShellRequest) {
